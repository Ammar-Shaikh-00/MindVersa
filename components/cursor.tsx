...
export function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const drawLine = () => {
      ...
      gradient.addColorStop(0.3, "rgba(0, 229, 255, 0.06)");
      gradient.addColorStop(0.65, "rgba(123, 97, 255, 0.24)");
      gradient.addColorStop(1, "rgba(0, 229, 255, 0.38)");
      ...
      ctx.lineWidth = 5;
      ctx.shadowBlur = 10;
      ctx.shadowColor = "rgba(0, 229, 255, 0.32)";
      ctx.stroke();
